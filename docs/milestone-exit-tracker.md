...
| **M6** | Job scheduler core | **Core met; persistence/utility IPC pending** | Validated DAGs, bounded queue, ADR priority classes, cooperative cancellation, progress/terminal events, fixed named worker threads; 9 unit tests [ADR-009, SDS §2.2.3] |
